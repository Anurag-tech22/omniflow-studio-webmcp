...
export const ARCHITECTURE_TEMPLATES = {
  'nvidia-gpu-ai': {
    ...
    connections: [
      ...
      { id: 'a4', from: 'ingress-ai', to: 'ray-orch', protocol: 'gRPC Streaming', latency: '2ms', throughput: '8.4k req/s' },
      ...
      { id: 'a7', from: 'ray-orch', to: 'vdb-1', protocol: 'HNSW Vector ANN', latency: '12ms', throughput: '2.4k req/s' },
      { id: 'a8', from: 'gpu-h100', to: 's3-ckpt', protocol: 'S3 Multi-part Read', latency: '28ms', throughput: '8.5 GB/s' }
    ]
  },
  ...
  'agent-swarm': {
    ...
    connections: [
      ...
      { id: 's2', from: 'swarm-lead', to: 'llm-reasoner', protocol: 'Server-Sent Events', latency: '8ms', throughput: '1.2k req/s' },
      { id: 's3', from: 'swarm-lead', to: 'tool-sandbox', protocol: 'gRPC Container Pipe', latency: '5ms', throughput: '850 exec/s' },
      { id: 's4', from: 'swarm-lead', to: 'agent-mem', protocol: 'Redis Hash', latency: '1ms', throughput: '8.5k req/s' },
      { id: 's5', from: 'llm-reasoner', to: 'vector-mem', protocol: 'Embedding Query', latency: '14ms', throughput: '920 req/s' },
      { id: 's6', from: 'swarm-lead', to: 'audit-db', protocol: 'Async Batch Insert', latency: '6ms', throughput: '1.2k log/s' }
    ]
  },
  ...
  ecommerce: {
    ...
    connections: [
      ...
      { id: 'c7', from: 'queue-1', to: 'db-pg', protocol: 'PostgreSQL Write', latency: '8ms', throughput: '2.1k w/s' },
