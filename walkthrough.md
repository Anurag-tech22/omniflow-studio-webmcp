...
graph TD
    ...
    subgraph WebMCP document.modelContext: 24 Tools
        ...
        Registry <--> SecOps[SOC2 & OWASP Security Auditor]
        Registry <--> Compiler[Multi-Cloud IaC: Terraform, Helm, CloudFormation]
    end

    subgraph Multi-Agent Swarm Arena
        Registry <--> Swarm[4-Agent Swarm Consensus: Architect, SecOps, FinOps, Chaos Daemon]
    end
```
